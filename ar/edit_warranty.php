						...
						if(isset($_GET['warranty_id']))
						{
							...
							echo '
								<div class="entry">
									<div class="content">
										<div class="header">
											<div class="title"><p style="float: right;">:إسم الضمان </p><br/><input type="text" name="product_name" value="'.$warranty['product_name'].'"></input></div>
											<div class="date"><p style="float: right;"> :إسم الشركة </p></br><input type="text" name="company_name" value="'.$warranty['company_name'].'"></input></div>
										</div>
									</div>
								...
								<div class="entry">
									<div class="content">
										...
										<div class="details"><br/>
											<p style="float: right;"><text style="float: right">:المدة </text> <input type="text" name="end_date" id="end_date" value="'.date($prefs['date_format'], strtotime($warranty['end_date'])).'"/> إلا <input type="text" name="start_date" id="start_date" value="'.date($prefs['date_format'], strtotime($warranty['start_date'])).'"/></p><br/>
										...
										if(isset($files)) {
											...
											echo '<p style="float: right;"> :إحذف ملفات</p> <div style="padding-left: 2em"><br/><br/><br/>';
											$j = 0;
											while($j < count($files)) {
												if($files[$j] != "") {
													...
													echo '<label style="float: right;">'.substr($files[$j], strrpos($files[$j], '/') + 1).' <input type="checkbox" name="delete_files[]" value="'.$files[$j].'"/></label>';
												}
												$j++;
											}
											echo '</div>';
