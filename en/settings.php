			...
			<form method="POST">
				<div class="control_menu">
					...
					if(isset($_POST['edit_account']))
						echo '<input type="submit" value="Save" name="edit_account_submit"/>
							  <input type="submit" value="Back" name="back"/>';
					if(isset($_POST['create_account']))
						echo '<input type="submit" value="Create" name="create_account_submit"/>
							  <input type="submit" value="Back" name="back"/>';
					if(isset($_POST['remove_account']))
						echo '<input type="submit" value="Remove" name="remove_account_submit"/>
							  <input type="submit" value="Back" name="back"/>';
					echo '</div>';
					?>
				</div>
						...
						<div class="content">
							...
							<?php
								...
								if(isset($_POST['list_all_accounts'])) {
									...
									echo '<br/><hr/><br/>
									<input type="submit" value="Save" name="edit_account_submit"/>
									<input type="submit" value="Back" name="back"/>';
									end_if_102:
									...
									echo '
										...
										<p>Please type the username <input type="text" name="remove_account_username" value="'.bbhp($_POST['remove_account_username']).'" readonly/> again: <input type="text" name="remove_account_verify_username"/></p>
										';
