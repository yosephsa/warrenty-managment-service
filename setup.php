		...
		<div class="setup_wrapper">
			...
			<div class="body_wrapper">
				<form class="body" method="POST">
					<?php
					$ini_file1 = '/ar/preferences.ini';
					$ini_file2 = '/en/preferences.ini';
					include_once '/en/constants.php';
						if(isset($_POST['back'])) {
							echo '<script>window.history.go(-2)</script>';
						} else if(isset($_POST['accept_terms_submit'])) {
							if(!isset($_POST['accept_terms'])) {
								echo '<script>window.alert("You must agree to the terms and conditions.");</script>';
								echo '<script>window.history.go(-2)</script>';
								return;
							} else {
							...
							if($content == "") {
								...
								echo '
									...
									<hr/>
									<br/>
										<label><input type="checkbox" value="" name="accept_terms">I accept the terms and conditions.</input></label>
