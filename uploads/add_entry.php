								...
								<div class="entry">
									<div class="content">
										...
										<div class="details"><br/>
											<p>Warranty Period: <input type="text" name="start_date" id="start_date" value="'.date($prefs['date_format'], strtotime($warranty['end_date'])).'"/> to <input type="text" name="end_date" id="end_date" value="'.date($prefs['date_format'], strtotime($warranty['end_date'])).'"/></p><br/>
