...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 28, 2016 at 10:42 AM
...
(51, 1, 'Ù†Ø¸Ø§Ù… Ø§Ù„Ù†Ø³Ø® Ø§Ù„Ø§Ø­ØªÙŠØ§Ø·ÙŠ  Veeam', 'Ø±Ø§ÙŠØ§Øª Ø§Ù„ØªÙ‚Ù†ÙŠØ©', 'active', '            ', '200000', '            ', '<p>DATA Ù…Ø¹ &nbsp;DOMAIN</p>', '', '2014-12-24', '2017-12-23', 'يوسف شريف العبدالوهاب', '2016-07-27'),
(53, 2, 'Core Switch (ØºØ±ÙØ© Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª (Ø§Ù„Ù…Ø¨Ø¯Ù„ Ø§Ù„Ø±Ø¦ÙŠØ³ÙŠ ', 'Ø±Ø§ÙŠØ§Øª Ø§Ù„ØªÙ‚Ù†ÙŠØ©', 'active', '  ', '9640', '  ', '', '', '2015-06-03', '2017-06-02', 'يوسف شريف العبدالوهاب', '2016-07-27'),
(55, 3, '3 Servers Ø±Ø®Øµ - VMWARE 6 CPUs', 'Ø²ÙŠÙ†ÙŠØ«', 'active', '  ', '84000', '  ', '', '', '2013-06-25', '2016-07-30', 'يوسف شريف العبدالوهاب', '2016-07-27'),
(57, 4, '3 Servers HP for Vmware', 'Ø§Ù„ÙÙ„Ùƒ', 'active', '', '8,500.00', '', '<p>ØªØ¬Ø¯ÙŠØ¯ Ø¬Ù‡Ø§Ø²ÙŠÙ† ÙÙ‚Ø· Ø­ØªÙ‰ 2017 Ø§Ù…Ø§ Ø§Ù„Ø¬Ù‡Ø§Ø² Ø§Ù„Ø§Ø®Ø± Ù„Ù… ÙŠØªØ¬Ø¯Ø¯</p>', '', '2015-06-10', '2017-04-29', 'يوسف شريف العبدالوهاب', '2016-07-27'),
